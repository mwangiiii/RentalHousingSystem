...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-6">
        <h1 class="text-4xl font-bold text-center text-gray-800 mb-6">Houses in Nairobi</h1>
        <div class="container mx-auto px-4 py-6">
        @if($houses->isEmpty())
                ...
                @foreach($houses as $house)
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden hover-grow transition-transform duration-300">
                        ...
                        <div class="p-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white">
                            ...
                            <form method="POST" action="{{ route('bookings.index', ['houseId' => $house->id]) }}" class="mt-4">
                                @csrf
