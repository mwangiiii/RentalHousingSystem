...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            ...
            <div class="mt-4">
                @if($fileUrl)
                    <a href="{{ $fileUrl }}" class="bg-blue-500 text-white px-4 py-2 rounded">View Lease Agreement</a>
                    <a href="{{ $fileUrl }}" download class="bg-green-500 text-white px-4 py-2 rounded">Download Lease Agreement</a>
                @else
                    <p>Lease agreement file not found.</p>
                @endif
            </div>
