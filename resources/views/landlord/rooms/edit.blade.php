                ...
                <form action="{{ route('landlord.rooms.update',$room) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <x-select name="property_id" id="property_id" class="mt-1 block w-full" :options="$properties" fieldName="name" idField="id" :selected="old('property_id', $room->property_id)" required></x-select>
                        </div>
                        <div class="col-span-6 sm:col-span-4">
